(function(g,f){typeof exports==='object'&&typeof module!=='undefined'?f(exports,require('tns-core-modules/platform'),require('tns-core-modules/color'),require('tns-core-modules/ui/page/page')):typeof define==='function'&&define.amd?define(['exports','tns-core-modules/platform','tns-core-modules/color','tns-core-modules/ui/page/page'],f):(g=g||self,f(g.NativescriptVueshadow={},g.platform,g.color,g.page));}(this,function(exports, platform, color, page){'use strict';var ShapeEnum;
(function (ShapeEnum) {
...
}exports.default=NSVueShadow;exports.install=install;Object.defineProperty(exports,'__esModule',{value:true});}));